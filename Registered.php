...
?>
  <div style="height:40%;
    ...
    <p style="font-size:11px;
              font-family:verdana;
              margin-left:3%;">
      Thank you for registering! An email has been sent to the 
      email address you provided while registering, 
      <br>please confirm your registration ASAP 
      in order to start using your account.</p>
  </div>
<?php
}
else{
  ...
  if($userdata->UpdateUserType($userid,$usertype)){
    Echo "<p id='regSuccessMsg' "
          . "style='color:white;"
          . "font-size:12px;'>"
    . "Thank you for activating your account. "
    . "Please use your userid and password to login"
    . "</p>";
  }
}
 require("footer.php"); 
