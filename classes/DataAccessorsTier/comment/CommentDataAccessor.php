<?PHP
  ...
  class CommentDataAccessor {
    ...
    public function addComment($comment) {
      ...
      if($rating_id != "" ) {
        $query_insert="INSERT INTO ".COMMENT." (com_text, com_rating_id, com_created_by, com_entry_id) 
                        VALUES ('".$text."', ".$rating_id.", ".$created_by.", '".$entry_id."')";
      } else {
        $query_insert="INSERT INTO ".COMMENT." (com_text, com_created_by, com_entry_id) 
                        VALUES ('".$text."', ".$created_by.", '".$entry_id."')";
      }
    ...
    public function getCommentByEntry($comment_entry_id) {
      ...
      $query = "SELECT * FROM ".COMMENT." WHERE com_entry_id = '".$comment_entry_id."'";
      $dbHelper = new DBHelper();
      $result = $dbHelper->executeQuery($query);
