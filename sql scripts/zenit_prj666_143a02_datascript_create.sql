CREATE TABLE `prj666_143a02`.`tbl_entry_english` (
...
CREATE TABLE  `prj666_143a02`.`tbl_media`(
...
CREATE TABLE  `prj666_143a02`.`tbl_sublangbridge`(
  `slb_sublangbridge_id`  INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
  `slb_subscribe_id`  INT,
  `slb_language_id`  INT
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE  `prj666_143a02`.`tbl_subscription`(
...
CREATE TABLE `prj666_143a02`.`tbl_author` (
...
CREATE TABLE `prj666_143a02`.`tbl_source` (
