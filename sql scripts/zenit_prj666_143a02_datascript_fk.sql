ALTER TABLE `prj666_143a02`.`tbl_entry_english`
...
ADD CONSTRAINT `tblEntryEnglish_tblAuthenStatus_ent_entry_authen_status_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_authen_status` (`athn_authen_status_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblUser_ent_entry_creator_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_user` (`usr_user_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblMedia_ent_entry_media_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_media` (`med_media_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblComment_ent_entry_comment_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_comment` (`com_comment_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblRating_ent_entry_rating_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_rating` (`rat_rating_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblAuthor_ent_entry_author_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_author` (`aut_author_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblEntryEnglish_tblSource_ent_entry_source_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_source` (`sou_source_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;

########table entry_russian
ALTER TABLE `prj666_143a02`.`tbl_entry_russian`
...
ALTER TABLE `prj666_143a02`.`tbl_entry_mandarin`
...
##------------table user-----------------
ALTER TABLE `prj666_143a02`.`tbl_user`
...
ADD CONSTRAINT `tblUser_tblLocation_usr_user_location_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_location` (`loc_location_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblUser_tblUserType_usr_user_user_type_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_user_type` (`utp_usertype_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;

#---------table rating--------------
ALTER TABLE `prj666_143a02`.`tbl_rating` 
...
#---------table sublangbridge-----------
ALTER TABLE `prj666_143a02`.`tbl_sublangbridge`
...
ADD CONSTRAINT `tblSublangbridge_tblSubscription_subscriber_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_subscription` (`sub_subscribe_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
...
ADD CONSTRAINT `tblSublangbridge_tblLanguage_lang_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_language` (`lan_language_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
 
#---------table location-----------
ALTER TABLE `prj666_143a02`.`tbl_location`
...
ADD CONSTRAINT `tblLocation_tblCity_loc_location_city_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_city` (`cty_city_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
 
#---------table city-----------
ALTER TABLE `prj666_143a02`.`tbl_city`
...
#---------table province-----------
ALTER TABLE `prj666_143a02`.`tbl_province` 
...
ADD CONSTRAINT `tblProvince_tblCountry_pro_province_country_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_country` (`con_country_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
 
#---------table comment-----------
ALTER TABLE `prj666_143a02`.`tbl_comment`
...
#---------table media-----------
ALTER TABLE `prj666_143a02`.`tbl_media`
...
ADD CONSTRAINT `tblMedia_tblMediaType_med_media_media_type_id_FK`
 ...
 REFERENCES `prj666_143a02`.`tbl_media_type` (`mtp_media_type_id`)
 ON DELETE NO ACTION
 ON UPDATE NO ACTION;
