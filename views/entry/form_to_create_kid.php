...
<!--    <br>views/entry/form_to_<mark>create</mark>_kid.php-->
      <div id="entry_create_form">
        ...
        <div class="entry_create_row">
          <div id="entry_create_form_title">
  ...
  <!--      <div class="entry_create_row">
        ...
        <div 
          ...
          <button name ="submit" type="submit" class="en_button">
            Submit
          </button>
