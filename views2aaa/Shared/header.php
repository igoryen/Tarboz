...
<head>
  <meta charset="UTF-8">
  <link rel="stylesheet" type="text/css" href="/Tarboz/plug-in/virtual_keyboard/keyboard.css">
    ...
    <div id="header">
      <div class="header_row">
        ...
        <nav id="navigation">
          ...
          <a href="/Tarboz/html_codes_to_use/Entry/Index.php">Entry Index</a>  
          <a href="/Tarboz/html_codes_to_use/Entry/Create.php">Entry Create</a>
          <a href="/Tarboz/html_codes_to_use/User/Index.php">User Index</a>     
          <a href="/Tarboz/html_codes_to_use/Login/Index.php">Login</a> 
        </nav>
      <!--  <div id="links"><a href="/Tarboz/html_codes_to_use/Login/Index.php">Login</a></div>-->
      </div>
    </div><!--"header"-->