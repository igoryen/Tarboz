...
SET foreign_key_checks = 0;
INSERT INTO `prj666`.`tbl_entry_mandarin` (`ent_entry_id`,`ent_entry_text`, `ent_entry_verbatim`, `ent_entry_translit`,`ent_entry_authen_status_id`,  `ent_entry_creator_id`, `ent_entry_comment_id`, `ent_entry_rating_id`,  `ent_entry_source_id`)
